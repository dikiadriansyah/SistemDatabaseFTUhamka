...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h4 style="margin-top: 80px">Edit Mahasiswa Bimbingan</h4>
      <hr>

      <!--form -->
      <?php foreach($sekret_edit_mhs as $sem) : ?>
        <form action="<?php echo site_url('dashboardKaprodi/aksi_edit_mhsbim') ?>" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="" value="<?php echo $sem->nama_mhs ?>" name="nama_mhs" readonly>

            <div class="form-group">
              <label for="exampleFormControlInput1">Judul Skripsi</label>
              <textarea class="form-control"  rows="3" name="j_skripsi" ><?php echo $sem->j_skripsi ?></textarea>
            <?php endforeach; ?>
            <!--form selesai-->
            ...
            <div class="text-center">
              ...
              <a style="margin-left:20px; margin-top: 20px" type="button" class="btn btn-danger" onclick="javascript:history.back()">Kembali</a>
               </form>
            </div>
