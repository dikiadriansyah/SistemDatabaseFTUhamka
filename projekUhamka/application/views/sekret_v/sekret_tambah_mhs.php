...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php echo form_open_multipart('sekretSK/tambah_aksi_mhs') ?>
...
<!-- 
      ...
      <!--    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" value="" name="ta_masuk"> -->
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" value="" name="j_skripsi"></textarea>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="text-center">
                              ...
                              <a type="submit" style="margin-left:20px; margin-top: 20px" class="btn btn-danger" href="<?= base_url('sekretSK/admin') ?>"><i class="fas fa-back"></i> Kembali</a>
                            </form>
                          </div>
